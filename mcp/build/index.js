...
function generateBattleStory(hero1, hero2) {
    ...
    if (powerDiff < 20) {
        ...
        if (winner.powerstats.strength > loser.powerstats.strength + 20)
            stats.push('strength');
        if (winner.powerstats.speed > loser.powerstats.speed + 20)
            stats.push('speed');
        if (winner.powerstats.combat > loser.powerstats.combat + 20)
            stats.push('combat');
...
server.tool("compare_superheroes", "Compare two superheroes and generate a battle story (up to 800 characters)", {
