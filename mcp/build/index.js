...
server.tool("list-superheros", "List all superheroes with their basic information", {}, async () => {
    const superheroes = await loadSuperheroes();
...
server.tool("compare-suoerheros", "Compare two superheroes by their powerstats", {
    ...
    const total1 = stats.reduce((sum, stat) => sum + foundHero1.powerstats[stat], 0);
    const total2 = stats.reduce((sum, stat) => sum + foundHero2.powerstats[stat], 0);
