...
This skill is based on the awesome copilot github skill called "make-skill-template".
...
## Quick Start: Duplicate This Skill as a Template

1. Copy the `skill-creator/` folder
